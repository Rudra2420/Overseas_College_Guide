                        ...
                        <div class="card-header border-0">
                            <div class="row align-items-center">
                                ...
                                <div class="col text-right">
                                    <a href="new_acc.php" class="btn btn-sm text-white" style="background: #eb5e0b">New</a>
                                </div>
                            </div>
                        </div>
                        <div class="table-responsive">
                            ...
                            <table class="table align-items-begin table-flush">
                                ...
                                <tbody>
                                    ...
                                    $offset = ($page - 1) * $limit;
                                      ...
                                      $clgqry = "SELECT * FROM accommodation WHERE uid='$uid' LIMIT {$offset},{$limit}";
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row2['acc_state'];  ?></td>
                                        <td><?php echo $row2['acc_country'];  ?></td>
                                        <td><?php echo $row2['acc_rent'];  ?></td>
                                        <td><?php echo $row2['acc_other_info'];  ?></td>
                                        <td>
                                                <a href="edit_acc.php?accid=<?= $row2['acc_id'] ?>" class="btn btn-sm text-white" style="background: #eb5e0b" >Update</a>
                                        </td>
                                        <td>
                                                <a href="delete_acc.php?accid=<?= $row2['acc_id'] ?>" class="btn btn-sm text-white" style="background: #eb5e0b" onclick="return confirm('Are you sure want to delete this college?');" >Delete</a>                                          
                                        </td>
                                    </tr>
                                    <?php
                            ...
                            <?php
                                ...
                                if($page > 1)
                                {
                                        ...
                                        <a class="page-link" href="manage_acc.php?page='.($page - 1).'">
                                ...
                                for($i = 1; $i <= $total_page; $i++)
                                {
                                    ...
                                    echo '<li class="page-item '.$active.'">
                                            <a class="page-link" href="manage_acc.php?page='.$i.'">'.$i.'<span class="sr-only">(current)</span></a>
                                        </li>';
                                }
