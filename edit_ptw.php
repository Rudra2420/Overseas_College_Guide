...
?>
  ...
  <head>
    ...
    <title>Overseas Dashboard - Workplace</title>
    <!-- Favicon -->
      ...
      <div class="scrollbar-inner">
        ...
        <div class="navbar-inner">
                ...
                <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link active" href="ptw_dashboard.php">
              ...
              <div class="col-lg-6 col-7">
                ...
                <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                  <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Update Workplace</li>
                  </ol>
                </nav>
              </div>
          ...
          <div class="card">
            <div class="card-header">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0">Edit Workplace</h3>
                </div>
            ...
            <div class="card-body"> 
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">Workplace Name</label>
                        <input type="text" name="wname" id="input-cityname" class="form-control" value="<?php echo $fetch['ptw_place_name']; ?>" >
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="cityname" id="input-cityname" class="form-control" value="<?php echo $fetch['ptw_city']; ?>" >
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="state" id="input-state-name" class="form-control"  value="<?php echo $fetch['ptw_state']; ?>">
                      </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="coname" id="input-country-name" class="form-control"  value="<?php echo $fetch['ptw_country']; ?>">
                      </div>
                    </div>
                    </div>
                ...
                <div class="pl-lg-4">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-hrs">Working Hours</label>
                        <input type="text" id="input-city" name="hrs" class="form-control"  value="<?php echo $fetch['ptw_hours']; ?>">
                      </div>
                    </div>

                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-salary">Salary</label>
                        <input type="text" id="input-city" name="salary" class="form-control"  value="<?php echo $fetch['ptw_salary']; ?>">
                      </div>
                    </div>
              
                    <div class="col-lg-12">
                      <div class="form-group">
                        <label class="form-control-label" for="input-details">Workplace Requriment</label>
                        <input type="text" id="input-first-name" name="details" class="form-control" value="<?php echo $fetch['ptw_requirement']; ?>">
                      </div>
                    </div>
        ...
        if(isset($_POST['update']))
                {
                    ...
                    $details1  = $_POST['details'];
                        ...
                        $upqry = "UPDATE part_time_work SET ptw_place_name='$wname1', ptw_city='$city1', ptw_state='$state1', ptw_country='$coname1', ptw_hours='$hrs1', ptw_salary='$salary1', ptw_requirement='$details1' WHERE ptw_id='$ptwid';";
