        ...
        <div class="navbar-inner">
                ...
                <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <hr class="my-3">
                        <li class="nav-item">
                            <a class="nav-link active" href="new_ptw.php">
              ...
              <div class="col-lg-6 col-7">
                ...
                <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                  <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Insert Workplace</li>
                  </ol>
                </nav>
              </div>
          ...
          <div class="card">
            <div class="card-header">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0">Insert Workplace</h3>
                </div>
            ...
            <div class="card-body"> 
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-wrok-name">Workplace Name</label>
                        <input type="text" name="wname" id="input-email" class="form-control" >
                      </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="cityname" id="input-email" class="form-control" >
                      </div>
                    </div>
                  </div>
                ...
                <!-- Address -->
                <h6 class="heading-small text-muted mb-4">Workplace information</h6>
                <div class="pl-lg-4">
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-city" name="hrs" class="form-control">
                      </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-city" name="salary" class="form-control">
                      </div>
                    </div>
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-12">
                      <div class="form-group">
                        <label class="form-control-label" for="input-details">Requirement</label>
        ...
        if(isset($_POST['insert']))
                {  
                    ...
                    $details1  = $_POST['details'];
                        ...
                        $sql = "INSERT INTO part_time_work (ptw_place_name ,ptw_city ,ptw_state ,ptw_country ,ptw_hours ,ptw_salary ,ptw_requirement , uid ) VALUES ('$wname1' ,'$city1' ,'$state1' ,'$coname1' ,'$hrs1' ,'$salary1' ,'$details1','$uid');";
                        $upexe = mysqli_query($conn, $sql);
                        if($upexe)
                        {
                            echo "<script>alert('Record Inserted...');</script>";
                            redirect('ptw_dashboard.php');
                        }
                        else{
