                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="card card-stats">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            <h4 class="card-title text-uppercase text-muted mb-0">Total Workplace</h4>

                                            <?php
                                                $selqry = "SELECT * FROM part_time_work WHERE uid='$uid'";
                                                $exeqry = mysqli_query($conn, $selqry);
                                                $ptwcnt = mysqli_num_rows($exeqry);
                                            ?>
                    ...
                    <div class="card">
                        <div class="card-header border-0">
                            <div class="row align-items-center">
                                <div class="col">
                                    <h3 class="mb-0">List of Workplace</h3>
                                </div>
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $offset = ($page - 1) * $limit;
                                          ...
                                          $uselqry = "SELECT * FROM part_time_work WHERE uid='$uid' LIMIT {$offset},{$limit}";
                                          $uexeqry = mysqli_query($conn, $uselqry);

                                          // $uselqry = "SELECT * FROM part_time_work";
                                          // $uexeqry = mysqli_query($conn, $uselqry);

                                          while ($row = mysqli_fetch_assoc($uexeqry)) {
                                          ?>
                                    <tr>
                                        <td><?php echo $row['ptw_place_name']  ?></td>
                                        <td><?php echo $row['ptw_city']  ?></td>
                                        <td><?php echo $row['ptw_state']  ?></td>
                                        <td><?php echo $row['ptw_country']  ?></td>
                                        <td><?php echo $row['ptw_hours']  ?></td>
                                        <td><?php echo $row['ptw_salary']  ?></td>
                                    </tr>
                                <?php
                                    }
                                ?>
