      ...
      <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" maxlength="10" id="input-first-name" name="admmob" class="form-control" value="<?php echo $adfetchary['umobile'] ?>">
                      </div>
                    </div>
       ...
       <footer class="footer pt-0">
        ...
        if(isset($_POST['adupdate']))
        {
            ...
            $upqry    = "UPDATE users SET uname='$adminname', uemail='$admemail',umobile='$admmob',ustate='$admstate',ucon='$admcon' WHERE uid='$uid' ";
