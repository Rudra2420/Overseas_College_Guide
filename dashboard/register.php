...
<head>
  ...
  <title>Overseas Dashboard - Register</title>
  <!-- Favicon -->
        ...
        <div class="col-lg-6 col-md-8">
          <div class="card bg-secondary border-0">
            <div class="card-header bg-transparent pb-5">
              <div class="text-muted text-center mt-2 mb-3"><b>Overseas</b></div>
            </div>
              ...
              <form role="form" method="post">
                ...
                <div class="form-group">
                  <div class="input-group input-group-merge input-group-alternative">
                    ...
                    <input class="form-control" name="cfpass" placeholder="Confirm Password" type="password">
                  </div>
                </div>

                <div class="text-center">
                  <button type="submit" name="sign_up" class="btn btn-primary mt-4">Create account</button>
                </div>
              </form>
            </div>
          </div>
...
if (isset($_POST['sign_up'])) {
    ...
    $emailqry = "SELECT * FROM overseas_admin WHERE adm_email='$uemail'";
    ...
    if ($emailcount>0) {
      ...
      if($upass === $ucfpass)
      {
        $insqry  =  "INSERT INTO overseas_admin (adm_name, adm_email, adm_pwd) VALUES ('$uname', '$uemail', '$ucfpass')"; 
