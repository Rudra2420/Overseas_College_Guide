              ...
              <div class="col-lg-6 col-7">
                ...
                <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                  <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Update Accommodation</li>
                  </ol>
                </nav>
              </div>
          ...
          <div class="card">
            <div class="card-header">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0">Edit Accommodation</h3>
                </div>
            ...
            <div class="card-body"> 
                <h6 class="heading-small text-muted mb-4">Accommodation information</h6>
                <div class="pl-lg-4">
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-username">Accommodation Other Details</label>
                        <input type="text" name="acc_o" id="input-username" class="form-control" value="<?php echo $fetch['acc_other_info']; ?>">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">Rent</label>
                        <input type="text" name="rent" id="input-email" class="form-control" value="<?php echo $fetch['acc_rent']; ?>" >
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="uid" id="input-last-name" class="form-control"  value="<?php echo $fetch['uid']; ?>">
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-city" name="city" class="form-control"  value="<?php echo $fetch['acc_city']; ?>">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-country">State</label>
                        <input type="text" id="input-country" name="state" class="form-control" value="<?php echo $fetch['acc_state']; ?>">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-first-name">Country</label>
                        <input type="text" id="input-first-name" name="con" class="form-control" value="<?php echo $fetch['acc_country']; ?>">
                      </div>
                    </div>
...
<?php
        if(isset($_POST['update']))
                {
                    $accoinfo = $_POST['acc_o'];
                    $rent = $_POST['rent'];
                    $city = $_POST['city'];
                    $state = $_POST['state'];
                    $con = $_POST['con'];

                        $upqry = "UPDATE accommodation SET  acc_city='$city', acc_state='$state', acc_country='$con', acc_rent='$rent', acc_other_info='$accoinfo' WHERE acc_id='$accid'";
