        ...
        <div class="col-xl-12 order-xl-1">
          <div class="card">
            ...
            <?php
                ...
                $selqry = "SELECT * FROM colleges WHERE clg_id='$clgid' ";
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="clgname" id="input-username" class="form-control" value="<?php echo $fetch['clg_name']; ?>">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">Intact</label>
                        <input type="text" name="intact" id="input-email" class="form-control" value="<?php echo $fetch['clg_intact']; ?>" >
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="exams" id="input-last-name" class="form-control"  value="<?php echo $fetch['clg_exams']; ?>">
                      </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="coname" id="input-last-name" class="form-control"  value="<?php echo $fetch['course_names']; ?>">
                      </div>
                    </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-city" name="state" class="form-control"  value="<?php echo $fetch['clg_state']; ?>">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-country">Country</label>
                        <input type="text" id="input-country" name="con" class="form-control" value="<?php echo $fetch['clg_country']; ?>">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-first-name">Website</label>
                        <input type="text" id="input-first-name" name="site" class="form-control" value="<?php echo $fetch['clg_website']; ?>">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
        ...
        if(isset($_POST['update']))
                {
                    ...
                    $intact = $_POST['intact'];
                    $exams = $_POST['exams'];
                    $courses = $_POST['coname'];
                    $site = $_POST['site'];
                    $state = $_POST['state'];
                    $con = $_POST['con'];

                        $image1 = $_FILES['clgimg']['name'];
                        $bro1 = $_FILES['brochure']['name'];

                        $imgdesti = 'assets/img/'.$image1;
                        $brodesti = 'assets/pdf/'.$bro1;

                        $upqry = "UPDATE colleges SET clg_name='$clgname', clg_intact='$intact', clg_exams='$exams', clg_state='$state', clg_country='$con', clg_website='$site', clg_brochure='$brodesti', course_names='$courses', clg_img='$imgdesti' WHERE clg_id='$clgid'";
