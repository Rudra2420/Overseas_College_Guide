                    ...
                    <div class="card">
                        <div class="card-header border-0">
                            <div class="row align-items-center">
                                <div class="col">
                                    <h3 class="mb-0">System Colleges</h3>
                                </div>
                            ...
                            <table class="table align-items-begin table-flush">
                                ...
                                <tbody>
                                    ...
                                    $offset = ($page - 1) * $limit;
                                      ...
                                      $clgqry = "SELECT * FROM colleges LIMIT {$offset},{$limit}";
                                    ...
                                    <tr>
                                        ...
                                        <th scope="row"><?php echo $row2['clg_id']; ?></th>
                                        <td scope="row"><img src="<?php echo $row2['clg_img']?>" alt="clg_img" style="width: 90px; height:90px;"></td>
                                        <th scope="row"><?php echo $row2['clg_name'];  ?></th>
                                        <!-- <td><?php //echo $row2['clg_intact'];  ?></td> -->
                                        <td><?php echo $row2['clg_website'];  ?></td>
                                        <td><?php echo $row2['clg_state'];  ?></td>
                                        <td><?php echo $row2['clg_country'];  ?></td>
                                        <td>
                                                <a href="update_colleges.php?clgid=<?= $row2['clg_id'] ?>" class="btn btn-sm btn-primary" >Update</a>
                                        </td>
                                        <td>
                                                <a href="delete_colleges.php?clgid=<?= $row2['clg_id'] ?>" class="btn btn-sm btn-primary" onclick="return confirm('Are you sure want to delete this college?');" >Delete</a>                                          
                                        </td>
                                    </tr>
                                    <?php
