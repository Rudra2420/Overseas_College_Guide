              ...
              <div class="col-lg-6 col-7">
                ...
                <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                  <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Part-Time-Work</li>
                  </ol>
                </nav>
              </div>
                    ...
                    <div class="card">
                        <div class="card-header border-0">
                            <div class="row align-items-center">
                                <div class="col">
                                    <h3 class="mb-0">Part-Time-Work</h3>
                                </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table align-items-begin table-flush">
                                <thead class="thead-light">
                                    <tr>
                                        <th scope="col">P-T-W_ID</th>
                                        <th scope="col">P-T-W_Place_Name</th>
                                        <th scope="col">P-T-W_State</th>
                                        <th scope="col">P-T-W_Country</th>
                                        <th scope="col">P-T-W_Hours</th>
                                        <th scope="col">P-T-W_Salary</th>
                                ...
                                <tbody>
                                    ...
                                    $offset = ($page - 1) * $limit;
                                      ...
                                      $clgqry = "SELECT * FROM part_time_work LIMIT {$offset},{$limit}";
                                    ...
                                    <tr>
                                        ...
                                        <th scope="row"><?php echo $row2['ptw_state'];  ?></th>
                                        <td><?php echo $row2['ptw_country'];  ?></td>
                                        <td><?php echo $row2['ptw_hours'];  ?></td>
                                        <td><?php echo $row2['ptw_salary'];  ?></td>
                                        <td><?php echo $row2['uid'];  ?></td>
                                        <td>
                                                <a href="update_ptw.php?ptw_id=<?= $row2['ptw_id'] ?>" class="btn btn-sm btn-primary" >Update</a>
                                        </td>
                                        <td>
                                                <a href="delete_ptw.php?ptw_id=<?= $row2['ptw_id'] ?>" class="btn btn-sm btn-primary" onclick="return confirm('Are you sure want to delete this college?');" >Delete</a>                                          
                                        </td>
                                    </tr>
                                    <?php
