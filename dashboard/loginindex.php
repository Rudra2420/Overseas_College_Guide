...
<head>
  ...
  <title>Overseas Dashboard - Login</title>
  <!-- Favicon -->
...
<body class="bg-default">
  ...
  <nav id="navbar-main" class="navbar navbar-horizontal navbar-transparent navbar-main navbar-expand-lg navbar-light">
    <div class="container">
      <a class="navbar-brand" href="loginindex.php">
      ...
      <div class="navbar-collapse navbar-custom-collapse collapse" id="navbar-collapse">
        ...
        <ul class="navbar-nav mr-auto">
          <li class="nav-item">
            <a href="loginindex.php" class="nav-link">
        ...
        <div class="col-lg-5 col-md-7">
          <div class="card bg-secondary border-0 mb-0">
            <div class="card-header bg-transparent pb-5">
              <div class="text-center "><b>Overseas</b></div>
            </div>
      ...
      <div class="row align-items-center justify-content-xl-between">
        <div class="col-xl-6">
          <div class="copyright text-center text-xl-left text-muted">
            &copy; 2021 <a href="#" class="font-weight-bold ml-1" target="_blank">Overseas</a>
          </div>
        </div>
        <div class="col-xl-6">
          <ul class="nav nav-footer justify-content-center justify-content-xl-end">
            <li class="nav-item">
              <a href="#" class="nav-link" target="_blank">Overseas</a>
            </li>
          </ul>
        </div>
      </div>
...
if(isset($_POST['login']))
    {
		$luseremail2	= $_POST['email'];
		$luserpass2	  = $_POST['pass'];
		
		$sql1 = "SELECT * FROM overseas_admin WHERE adm_email='$luseremail2' AND adm_pwd='$luserpass2' ";
		$res1 = mysqli_query($conn,$sql1);
		
		if(mysqli_num_rows($res1)>0)
		{
        $row1 = mysqli_fetch_assoc($res1);
			  $_SESSION['overseas_admin'] = $row1['adm_email'];
